...
\begin{itemize}
    ...
    \item \textbf{Pre-trained Checkpoints}: Pre-trained ACT policy checkpoints for all three tasks trained on real robot demonstrations are available at: \url{https://cloud.tsinghua.edu.cn/d/bc1e7b7e9fae40a39160/}. Download and place the \texttt{checkpoint\_real\_robot/} directory in the project root for direct deployment and evaluation.
\end{itemize}
...
We self-assess according to the given criteria. \textbf{Data:} \texttt{eval\_results/baseline\_no\_disturbance}, \texttt{baseline\_with\_disturbance}, \texttt{augmented\_no\_disturbance}, \texttt{augmented\_with\_disturbance} under \texttt{AvoidObstacleSO101-v1/}.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Difference from codebase (0.5 pt):} We add an online \texttt{VisualAugmentation} in \texttt{ACTPolicy.forward} and a custom \texttt{grasp\_cube/utils/data\_augmentation.py}; LeRobot only does resize and normalization. \checkmark
...
\vspace{1em}
\textbf{Repository:} \url{https://github.com/Gotham-Zolio/so101-grasp-cube}
